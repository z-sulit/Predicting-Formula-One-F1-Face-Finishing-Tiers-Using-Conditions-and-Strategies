...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{figures/fig1_class_distribution.pdf}
...
the engineered features, especially the interaction term and its component
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{figures/fig2_vif.pdf}
...
The near-perfect VIF of 1.007 for grid position confirms that starting
position and within-race telemetry are statistically independent. This is
physically expected because grid position is determined in qualifying,
whereas tire age and fuel mass accumulate during the race.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/fig3_coefficients.pdf}
...
Scorer tiers ($p = 0.000$ for both). The coefficient of $-0.80$ for Podium means that each position
...
\paragraph{Degradation $\times$ Fuel.}
With grid position controlling for raw car pace, the interaction term achieves
significance at $\alpha < 0.01$ for the Podium tier ($p = 0.0095$). The positive coefficient
...
\paragraph{Fuel\_Mass\_Proxy.}
Fuel mass is significant for both tiers ($p = 0.0009$ for Podium and $p = 0.0003$ for Point Scorer). The negative coefficients mean that
...
\paragraph{Tire\_MEDIUM.}
Medium tire compound is significant for the Point Scorer tier ($p = 0.0008$) with a negative
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{figures/fig5_gridposition_boxplot.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/fig6_scatter_tierfuel.pdf}
  \caption{Tire Age vs.\ Fuel Mass by Tier}
  \label{fig:scatter}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{figures/fig4_confusion_matrix.pdf}
