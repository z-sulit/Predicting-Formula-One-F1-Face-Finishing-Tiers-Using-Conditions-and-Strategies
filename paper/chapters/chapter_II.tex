...
\noindent
The interaction term is mean-centered before multiplication to prevent
structural multicollinearity. This allows the coefficient to be interpreted
as the \textit{combined} effect of both forces rather than their individual
contributions.
